...
folder_01.source = qml/qmlpptest
...
target_qtquick1 {
    ...
    qmlPreprocessFolder($$PWD/qml/qmlpptest, @QtQuick1 @JavaScriptTest1, 1.1)
    ...
    qmlPreprocessFolder($$PWD/qml/qmlpptest, @QtQuick2 @JavaScriptTest2, 2.1)
